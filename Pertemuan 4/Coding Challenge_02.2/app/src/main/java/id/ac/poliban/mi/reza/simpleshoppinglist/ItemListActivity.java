package id.ac.poliban.mi.reza.simpleshoppinglist;
...
import id.ac.poliban.mi.reza.simpleshoppinglist.databinding.ActivityItemListBinding;

public class ItemListActivity extends AppCompatActivity {
    public final static String ITEM_TAG = "id.ac.poliban.mi.reza.simpleshoppinglist.EXTRA.ITEM";
